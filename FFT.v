// megafunction wizard: %FFT v10.1%
// GENERATION: XML

// ============================================================
// Megafunction Name(s):
// 			asj_fft_dualstream_fft_101
// ============================================================
// Generated by FFT 10.1 [Altera, IP Toolbench 1.3.0 Build 153]
// ************************************************************
...
module FFT (
	...
	asj_fft_dualstream_fft_101	asj_fft_dualstream_fft_101_inst(
		.clk(clk),
		.reset_n(reset_n),
		.inverse(inverse),
	...
	defparam
		asj_fft_dualstream_fft_101_inst.nps = 2048,
		asj_fft_dualstream_fft_101_inst.bfp = 1,
		asj_fft_dualstream_fft_101_inst.nume = 2,
		asj_fft_dualstream_fft_101_inst.mpr = 16,
		asj_fft_dualstream_fft_101_inst.twr = 16,
		asj_fft_dualstream_fft_101_inst.bpr = 16,
		asj_fft_dualstream_fft_101_inst.bpb = 4,
		asj_fft_dualstream_fft_101_inst.fpr = 4,
		asj_fft_dualstream_fft_101_inst.mram = 0,
		asj_fft_dualstream_fft_101_inst.m512 = 0,
		asj_fft_dualstream_fft_101_inst.mult_type = 1,
		asj_fft_dualstream_fft_101_inst.mult_imp = 0,
		asj_fft_dualstream_fft_101_inst.dsp_arch = 0,
		asj_fft_dualstream_fft_101_inst.srr = "AUTO_SHIFT_REGISTER_RECOGNITION=OFF",
		asj_fft_dualstream_fft_101_inst.rfs1 = "FFT_1n2048sin.hex",
		asj_fft_dualstream_fft_101_inst.rfs2 = "FFT_2n2048sin.hex",
		asj_fft_dualstream_fft_101_inst.rfs3 = "FFT_3n2048sin.hex",
		asj_fft_dualstream_fft_101_inst.rfc1 = "FFT_1n2048cos.hex",
		asj_fft_dualstream_fft_101_inst.rfc2 = "FFT_2n2048cos.hex",
		asj_fft_dualstream_fft_101_inst.rfc3 = "FFT_3n2048cos.hex";
endmodule
...
// Retrieval info: <MEGACORE title="FFT MegaCore Function"  version="10.1"  build="153"  iptb_version="1.3.0 Build 153"  format_version="120" >
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.FFTModelClass"  active_core="asj_fft_dualstream_fft_101" >
...
// Retrieval info:      <PRIVATE name = "NUM_LE" value="6410"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "NUM_M4K" value="38"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "NUM_MEMBITS" value="311296"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "DEVICE" value="EP4CE22F17C6"  type="STRING"  enable="1" />
